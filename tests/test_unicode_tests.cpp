...
class UnicodeTestsTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(UnicodeTestsTest, MockDriverTests) {
    ...
    tests::UnicodeTests test_suite(conn);
    ...
    EXPECT_GT(passed, 0) << "At least some Unicode tests should pass";
