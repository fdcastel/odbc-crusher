...
class CursorBehaviorTestsTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(CursorBehaviorTestsTest, MockDriverTests) {
    ...
    tests::CursorBehaviorTests test_suite(conn);
    ...
    EXPECT_GT(passed, 0) << "At least some cursor behavior tests should pass";
}
