...
class StatementTestsTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(StatementTestsTest, RunFirebirdStatementTests) {
    ...
    tests::StatementTests tests(conn);
...
TEST_F(StatementTestsTest, RunMySQLStatementTests) {
