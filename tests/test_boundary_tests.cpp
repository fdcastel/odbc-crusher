...
TEST(BoundaryTests, MockDriverTests) {
    ...
    tests::BoundaryTests tests(*conn);
    ...
    EXPECT_GT(passed, 0) << "At least some boundary tests should pass";
    EXPECT_EQ(errors, 0) << "No boundary tests should error";
}
