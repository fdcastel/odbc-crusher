...
class NumericStructTestsTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(NumericStructTestsTest, MockDriverTests) {
    ...
    tests::NumericStructTests test_suite(conn);
    ...
    EXPECT_GT(passed, 0) << "At least some numeric struct tests should pass";
}
