...
SQLRETURN SQL_API SQLColumns(
    ...
    setup_catalog_result(stmt,
        ...
        {SQL_WVARCHAR, SQL_WVARCHAR, SQL_WVARCHAR, SQL_WVARCHAR, SQL_SMALLINT,
         SQL_WVARCHAR, SQL_INTEGER, SQL_INTEGER, SQL_SMALLINT, SQL_SMALLINT,
...
SQLRETURN SQL_API SQLStatistics(
    ...
    setup_catalog_result(stmt,
        ...
        {SQL_WVARCHAR, SQL_WVARCHAR, SQL_WVARCHAR, SQL_SMALLINT, SQL_WVARCHAR,
         SQL_WVARCHAR, SQL_SMALLINT, SQL_SMALLINT, SQL_WVARCHAR, SQL_WCHAR,
         SQL_INTEGER, SQL_INTEGER, SQL_WVARCHAR});
...
SQLRETURN SQL_API SQLSpecialColumns(
    ...
    setup_catalog_result(stmt,
        ...
        {SQL_SMALLINT, SQL_WVARCHAR, SQL_SMALLINT, SQL_WVARCHAR, SQL_INTEGER,
...
SQLRETURN SQL_API SQLColumnPrivileges(
    ...
    setup_catalog_result(stmt,
        ...
        {SQL_WVARCHAR, SQL_WVARCHAR, SQL_WVARCHAR, SQL_WVARCHAR, SQL_WVARCHAR,
         SQL_WVARCHAR, SQL_WVARCHAR, SQL_WVARCHAR});
